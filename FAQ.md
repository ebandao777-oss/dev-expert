...
- **四个"专项 reference"不支持 `@` 显式调用**：`@laravel-development` / `@laravel-testing` / `@java-development` / `@javascript-development` 只作领域协同资料，用关键词触发即可（见 七、Q5 / 十四、Q1）。
...
> **本节要点**：SELF-AUDIT 11 条、收尾报告 5 字段、Graceful Abort、错误册 ERR-XXX、学习捕获三层闭环。
