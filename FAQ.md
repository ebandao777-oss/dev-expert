...
- **五个"专项 reference"不支持 `@` 显式调用**：`@laravel-development` / `@laravel-testing` / `@java-development` / `@javascript-development` / `@architecture-decision` 只作领域协同资料，用关键词触发即可（见 七、Q5 / 十四、Q1）。
