---
name: dev-expert
description: 编程专家P8级,覆盖：软件/网站项目总控、API设计、Bug诊断、代码生成、代码审查、重构、测试用例、性能基准、技术选型、文档生成、任务拆解、Spec驱动、Karpathy规范、CMS二次开发、前端设计、MySQL、项目知识图谱。支持 @标识 显式调用跳过路由；Laravel/PHP、Java/Spring 以 reference 按需加载。
version: "1.12.0"
author: "智慧半岛"
license: MIT
allowed-tools:
